"""Tests for the get_message_context tool serialization."""

from datetime import datetime

from whatsapp_mcp.core import Message, MessageContext
from whatsapp_mcp.tools import messages as tools_messages
...
def test_get_message_context_serializes_dataclass(monkeypatch):
    ...
    result = tools_messages.get_message_context("target", before=1, after=1)
